...
cdef class Constraints:
    ...
    def __init__(self,*args,tol = 1.0e-6):
        '''
        ...
        self.cst_parameters = ['beta_x','alpha_x','beta_y','alpha_y','beta_z','alpha_z','eta_x',
                                    'etap_x','eta_y','etap_y','eta_z','etap_z','nu_x','nu_y','nu_z','emit','chromx','chromy','angle','s']
        ...
        self.twiss2index = {'beta_x':0,'alpha_x':1,'gamma_x':2,'beta_y':3,'alpha_y':4,'gamma_y':5,
                                ...
                                'eta_x':12,'etap_x':13,'eta_y':14,'etap_y':15,'eta_z':16,'etap_z':17, 'emit':0,'chromx':6,'chromy':7,'angle':1,'s':2}
        self.index.resize(4)
    ...
    cdef void get_constraints(self, tuple args, dict kargs):
        ...
        for key,value in kargs.items():
            ...
            if key in self.cst_parameters[15:18]:
                index = 2
            elif key in self.cst_parameters[18:]:
                index = 3
            ...
            self.index[0].push_back(index) # 0/1/2 mean difference/value/global_value
